...
//*
//*********************************************************************
//* JOB:     BUILDDMP (FIXED VERSION)                                 *
//* PURPOSE: Assemble and link DUMPPGM for IPCS practice             *
//* NOTE:    Source code is included inline - Fixed continuation      *
//*********************************************************************
//*
...
*
         MVC   BUFFER(44),=C'This is sample data for IPCS dump analysis'
         MVC   BUFFER+100(36),=C'Look for this string in the dump!'
*
         L     R14,RETADDR          Restore return address
         BR    R14                  Return
*
