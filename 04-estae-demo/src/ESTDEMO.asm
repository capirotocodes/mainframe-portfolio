...
MAINGO   DS    0H
         ESTAEX RECVEXIT             ESTABLISH RECOVERY EXIT
...
*          (PARAM/SDWAPARM PATH DID NOT DELIVER HERE - SEE DESIGN.MD)
*=====================================================================
RECVEXIT DS    0H
...
*  ---- FORMAT SDWA: PSW AT ERROR -------------------------------
         ...
         BAL   R6,PUTWTO
*  ---- DECIDE: RETRY (MODEFLAG=RETRY) OR PERCOLATE -------------
         LR    R1,R2               SETRP NEEDS R1 -> SDWA
         CLI   MODEFLAG,MODEPERC   PERCOLATE REQUESTED?
         JE    DOPERC
         SETRP RC=4,RETADDR=RETRYPT,RETREGS=YES,FRESDWA=YES
         J     EXITRTM
DOPERC   DS    0H
         MVC   WTOTXT,MSGPERC      PERCOLATE MESSAGE
         BAL   R6,PUTWTO
         LR    R1,R2               R1 -> SDWA (PUTWTO CLOBBERS R1)
